...
class Decision: Identifiable {
    ...
    static func createDecisions() -> [Decision] {
        return [
            ...
            Decision(title: .august, subtitle: "Apparently, one of your coworkers had an affair with a manager from another team, but both of them are married to other people!! \n\nHow enticing...", callToAction: "will you gossip about this?", choices: [
            ...
            Decision(title: .october, subtitle: "Finally, the fourth quarter arrives.\n\nA big, new project is announced and your boss nominates you to represent your department. \n\nYou can", callToAction: "choose to bring someone else to help you or try to deal with it on your own.", choices: [
