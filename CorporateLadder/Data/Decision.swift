...
class Decision: Identifiable {
    ...
    static func createDecisions() -> [Decision] {
        return [
            ...
            Decision(title: .june, subtitle: "Knowing you have a bit more time on your hands, your boss hands you a list of activities you could choose to do this month in order to deliver more value to the stakeholders. The alternative would be sticking to your current workload...", choices: [
